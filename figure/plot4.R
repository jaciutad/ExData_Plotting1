...
par(mfrow=c(2,2))
with(rawFiltered,plot(DateTimeFormat,Global_active_power,type="l",xlab='',ylab='Global Active Power')) 
with(rawFiltered,plot(DateTimeFormat,Voltage,type="l",xlab='datetime',ylab='Voltage')) 
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"),bty='n', lty=1, cex=.65)
with(rawFiltered,plot(DateTimeFormat,Global_reactive_power,type="l",xlab='datetime',ylab='Global_reactive_power')) 
